...
## Follow up
I followed these instructions for [starting a new Git repository](https://git-scm.com/docs/git-init#Documentation/git-init.txt-StartanewGitrepositoryforanexistingcodebase) (or, I guess, reinitializing). I had to google to establish that `git commit` alone was insufficient. I had to use `git commit -m "Initial commit"` instead. (This note included for the benefit of any fellow newbies who comes across this post. Those with more experience, feel free to shake your head at my blind spots.)
