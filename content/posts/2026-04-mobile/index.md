...
date = '2026-04-10'
draft = 'false'
title = 'So that’s where the “mobile” comes from'
tags = ['ham radio','amateur radio','PMRC','1950s','history','jim spencer','silent keys']
image = 'pmrc-banner.png'
author = 'KD3CPY'
+++
...
*The Blurb* sent me on a quick web search for the movie "Every Single Minute." It's on [YouTube](https://www.youtube.com/watch?v=xYx8VNzYwRE), preceded by a (differently) dated introductory interview. I urge you to spend 23 minutes taking in the low-quality but delightful video. From a purely informational perspective, the 1959 movie depicts mid-century equipment, vehicles, and costumes; on-air communication conventions; and some details about flooding that followed Hurricane Diane (1955) and the club's efforts to assist during the emergency.
